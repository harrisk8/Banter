...
11. **Do not over-optimize and do not optimize things that shouldn't exist in the first place. Example: Firebase charged $0.18/100K writes and $0.06/100K reads. I took this constaint too seriously and it skewed many of my engineering decisions and slowed down progress. I wrote my code in such a manner that absolutely minimized database reads/writes. In reality, this design was financially insignificant (ironically) but created unnecessary complexity + bugs.**
